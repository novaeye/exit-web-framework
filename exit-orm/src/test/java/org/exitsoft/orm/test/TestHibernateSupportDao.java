...
public class TestHibernateSupportDao {
	...
	public void testFind() {
		...
		filters = PropertyFilterBuilder.build(new String[]{"LIKES_name"}, new String[]{"系统"});
	...
	public void testFindUnique() {
		...
		filters = PropertyFilterBuilder.build(new String[]{"EQS_name"}, new String[]{"系统"});
	...
	public void testFindPage() {
		...
		List<PropertyFilter> filters = PropertyFilterBuilder.build(new String[]{"EQI_state"}, new String[]{"1"});
		...
		filters = PropertyFilterBuilder.build(new String[]{"EQS_name"}, new String[]{"系统管理员"});
