...
public class TestHibernateSupportDao {
	...
	public void testFind() {
		...
		filters = PropertyFilterBuilders.build(new String[]{"LIKES_loginName","EQI_state"}, new String[]{"m","1"});
		...
		filters = PropertyFilterBuilders.build(new String[]{"LIKES_name"}, new String[]{"系统"});
	...
	public void testFindUnique() {
		...
		List<PropertyFilter> filters = new ArrayList<PropertyFilter>();
		filters = PropertyFilterBuilders.build(new String[]{"EQS_loginName"}, new String[]{"admin"});
		
		user = dao.findUniqueByPropertyFilters(filters);
		Assert.assertEquals(user.getId(), "SJDK3849CKMS3849DJCK2039ZMSK0002");
		
		filters = PropertyFilterBuilders.build(new String[]{"EQS_name"}, new String[]{"系统"});
	...
	public void testFindPage() {
		...
		List<PropertyFilter> filters = PropertyFilterBuilders.build(new String[]{"EQI_state"}, new String[]{"1"});
		...
		filters = PropertyFilterBuilders.build(new String[]{"EQS_name"}, new String[]{"系统管理员"});
